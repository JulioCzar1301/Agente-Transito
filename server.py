...
TOOLS = [
    ...
    {
        "name": "query_api",
        "description": "Retorna ao usuário a resposta do modelo fine-tuned para o prompt fornecido",
        "inputSchema": {
            "type": "object",
            "properties": {
                "prompt": {"type": "string", "description": "Prompt para o modelo"}
            },
            "required": ["prompt"]
        }
    }
    ...
    try:
        ...
        if method == "initialize":
            ...
            if nome == "simulado_geral":
                ...
                resultado = query_api(args.get("prompt", ""))
            else:
